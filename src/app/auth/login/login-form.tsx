      ...
      <div className="glass-panel w-full max-w-sm rounded-2xl p-8">
        ...
        <div className="space-y-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-border/30 bg-secondary px-3 py-2 text-sm hover:bg-secondary/80 transition-colors"
          >
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          还没有账号？{" "}
          <Link href="/auth/register" className="text-amber-gold hover:underline">
            立即注册
          </Link>
        </p>
      </div>
